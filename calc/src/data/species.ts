...
const RBY: {[name: string]: SpeciesData} = {
  ...
  Arbok: {t1: 'Poison', bs: {hp: 60, at: 85, df: 69, sp: 80, sl: 65}, weightkg: 65},
  Arcanine: {
    t1: 'Fire',
  ...
  Clefable: {t1: 'Normal', bs: {hp: 95, at: 70, df: 73, sp: 60, sl: 85}, weightkg: 40},
  Clefairy: {
    t1: 'Normal',
  ...
  Ditto: {t1: 'Normal', bs: {hp: 48, at: 48, df: 48, sp: 48, sl: 48}, weightkg: 4},
  Dodrio: {
    t1: 'Normal',
    t2: 'Flying',
  ...
  Flareon: {t1: 'Fire', bs: {hp: 65, at: 130, df: 60, sp: 65, sl: 110}, weightkg: 25},
  Gastly: {
    t1: 'Ghost',
    t2: 'Poison',
  ...
  Golduck: {t1: 'Water', bs: {hp: 80, at: 82, df: 78, sp: 85, sl: 80}, weightkg: 76.6},
  Golem: {
    t1: 'Rock',
    t2: 'Ground',
  ...
  Kingler: {t1: 'Water', bs: {hp: 55, at: 130, df: 115, sp: 75, sl: 50}, weightkg: 60},
  Koffing: {
    t1: 'Poison',
  ...
  Marowak: {t1: 'Ground', bs: {hp: 60, at: 80, df: 110, sp: 45, sl: 50}, weightkg: 45},
  Meowth: {
    t1: 'Normal',
  ...
  Muk: {t1: 'Poison', bs: {hp: 105, at: 105, df: 75, sp: 50, sl: 65}, weightkg: 30},
  Nidoking: {
    t1: 'Poison',
    t2: 'Ground',
  ...
  Persian: {t1: 'Normal', bs: {hp: 65, at: 70, df: 60, sp: 115, sl: 65}, weightkg: 32},
  Pidgeot: {
    t1: 'Normal',
    t2: 'Flying',
  ...
  Pinsir: {t1: 'Bug', bs: {hp: 65, at: 125, df: 100, sp: 85, sl: 55}, weightkg: 55},
  Poliwag: {
    t1: 'Water',
  ...
  Rapidash: {t1: 'Fire', bs: {hp: 65, at: 100, df: 70, sp: 105, sl: 80}, weightkg: 95},
  Raticate: {
    t1: 'Normal',
  ...
  Seadra: {t1: 'Water', bs: {hp: 55, at: 65, df: 95, sp: 85, sl: 95}, weightkg: 25},
  Seaking: {t1: 'Water', bs: {hp: 80, at: 92, df: 65, sp: 68, sl: 80}, weightkg: 39},
  Seel: {
    t1: 'Water',
...
const GSC_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  // gen 2 pokemon
  Aipom: {t1: 'Normal', bs: {hp: 55, at: 70, df: 55, sa: 40, sd: 55, sp: 85}, weightkg: 11.5},
  Ampharos: {t1: 'Electric', bs: {hp: 90, at: 75, df: 75, sa: 115, sd: 90, sp: 55}, weightkg: 61.5},
  Ariados: {
    t1: 'Bug',
    t2: 'Poison',
  ...
  Azumarill: {t1: 'Water', bs: {hp: 100, at: 50, df: 80, sa: 50, sd: 80, sp: 50}, weightkg: 28.5},
  Bayleef: {
    t1: 'Grass',
  ...
  Bellossom: {t1: 'Grass', bs: {hp: 75, at: 80, df: 85, sa: 90, sd: 100, sp: 50}, weightkg: 5.8},
  Blissey: {t1: 'Normal', bs: {hp: 255, at: 10, df: 10, sa: 75, sd: 135, sp: 55}, weightkg: 46.8},
  Celebi: {
    t1: 'Psychic',
    t2: 'Grass',
  ...
  Donphan: {t1: 'Ground', bs: {hp: 90, at: 120, df: 120, sa: 60, sd: 60, sp: 50}, weightkg: 120},
  Dunsparce: {t1: 'Normal', bs: {hp: 100, at: 70, df: 70, sa: 65, sd: 65, sp: 45}, weightkg: 14},
  Elekid: {
    t1: 'Electric',
  ...
  Espeon: {t1: 'Psychic', bs: {hp: 65, at: 65, df: 60, sa: 130, sd: 95, sp: 110}, weightkg: 26.5},
  Feraligatr: {t1: 'Water', bs: {hp: 85, at: 105, df: 100, sa: 79, sd: 83, sp: 78}, weightkg: 88.8},
  Flaaffy: {
    t1: 'Electric',
  ...
  Furret: {t1: 'Normal', bs: {hp: 85, at: 76, df: 64, sa: 45, sd: 55, sp: 90}, weightkg: 32.5},
  Girafarig: {
    t1: 'Normal',
    t2: 'Psychic',
  ...
  Granbull: {t1: 'Normal', bs: {hp: 90, at: 120, df: 75, sa: 60, sd: 60, sp: 45}, weightkg: 48.7},
  Heracross: {
    t1: 'Bug',
    t2: 'Fighting',
  ...
  Hitmontop: {t1: 'Fighting', bs: {hp: 50, at: 95, df: 95, sa: 35, sd: 110, sp: 70}, weightkg: 48},
  'Ho-Oh': {
    t1: 'Fire',
    t2: 'Flying',
  ...
  Meganium: {t1: 'Grass', bs: {hp: 80, at: 82, df: 100, sa: 83, sd: 100, sp: 80}, weightkg: 100.5},
  Miltank: {t1: 'Normal', bs: {hp: 95, at: 80, df: 105, sa: 40, sd: 70, sp: 100}, weightkg: 75.5},
  Misdreavus: {
    t1: 'Ghost',
  ...
  Octillery: {t1: 'Water', bs: {hp: 75, at: 105, df: 75, sa: 105, sd: 75, sp: 45}, weightkg: 28.5},
  Phanpy: {
    t1: 'Ground',
  ...
  Politoed: {t1: 'Water', bs: {hp: 90, at: 75, df: 75, sa: 90, sd: 100, sp: 70}, weightkg: 33.9},
  Porygon2: {
    t1: 'Normal',
  ...
  Smeargle: {t1: 'Normal', bs: {hp: 55, at: 20, df: 35, sa: 20, sd: 45, sp: 75}, weightkg: 58},
  Smoochum: {
    t1: 'Ice',
    t2: 'Psychic',
  ...
  Stantler: {t1: 'Normal', bs: {hp: 73, at: 95, df: 62, sa: 85, sd: 65, sp: 85}, weightkg: 71.2},
  Steelix: {
    t1: 'Steel',
    t2: 'Ground',
  ...
  Sudowoodo: {t1: 'Rock', bs: {hp: 70, at: 100, df: 115, sa: 30, sd: 65, sp: 30}, weightkg: 38},
  Suicune: {
    t1: 'Water',
  ...
  Sunflora: {t1: 'Grass', bs: {hp: 75, at: 75, df: 55, sa: 105, sd: 85, sp: 30}, weightkg: 8.5},
  Sunkern: {
    t1: 'Grass',
  ...
  Typhlosion: {t1: 'Fire', bs: {hp: 78, at: 84, df: 78, sa: 109, sd: 85, sp: 100}, weightkg: 79.5},
  Tyranitar: {
    t1: 'Rock',
    t2: 'Dark',
  ...
  Umbreon: {t1: 'Dark', bs: {hp: 95, at: 65, df: 110, sa: 60, sd: 130, sp: 65}, weightkg: 27},
  Unown: {
    t1: 'Psychic',
  ...
  Ursaring: {t1: 'Normal', bs: {hp: 90, at: 130, df: 75, sa: 75, sd: 75, sp: 55}, weightkg: 125.8},
  Wobbuffet: {t1: 'Psychic', bs: {hp: 190, at: 33, df: 58, sa: 33, sd: 58, sp: 33}, weightkg: 28.5},
  Wooper: {
    t1: 'Water',
    t2: 'Ground',
...
const ADV_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Chansey: {ab: 'Natural Cure'},
  Charizard: {ab: 'Blaze'},
  Charmander: {ab: 'Blaze'},
  Charmeleon: {ab: 'Blaze'},
  Clefable: {ab: 'Cute Charm'},
  Clefairy: {ab: 'Cute Charm'},
  Cloyster: {ab: 'Shell Armor'},
  Cubone: {ab: 'Rock Head'},
  Dewgong: {ab: 'Thick Fat'},
  Diglett: {ab: 'Sand Veil'},
  Ditto: {ab: 'Limber'},
  Dodrio: {ab: 'Run Away'},
  Doduo: {ab: 'Run Away'},
  ...
  Onix: {ab: 'Rock Head'},
  Paras: {ab: 'Effect Spore'},
  Parasect: {ab: 'Effect Spore'},
  Persian: {ab: 'Limber'},
  Pidgeot: {ab: 'Keen Eye'},
  Pidgeotto: {ab: 'Keen Eye'},
  Pidgey: {ab: 'Keen Eye'},
  Pikachu: {ab: 'Static'},
  Pinsir: {ab: 'Hyper Cutter'},
  ...
  Psyduck: {ab: 'Damp'},
  Raichu: {ab: 'Static'},
  Rapidash: {ab: 'Run Away'},
  Raticate: {ab: 'Run Away'},
  Rattata: {ab: 'Run Away'},
  Rhydon: {ab: 'Lightning Rod'},
  Rhyhorn: {ab: 'Lightning Rod'},
  ...
  Seel: {ab: 'Thick Fat'},
  Shellder: {ab: 'Shell Armor'},
  Slowbro: {ab: 'Oblivious'},
  Slowpoke: {ab: 'Oblivious'},
  Snorlax: {ab: 'Immunity'},
  Spearow: {ab: 'Keen Eye'},
  Squirtle: {ab: 'Torrent'},
  Starmie: {ab: 'Illuminate'},
  Staryu: {ab: 'Illuminate'},
  Tangela: {ab: 'Chlorophyll'},
  Tauros: {ab: 'Intimidate'},
  Tentacool: {ab: 'Clear Body'},
  Tentacruel: {ab: 'Clear Body'},
  Vaporeon: {ab: 'Water Absorb'},
  Venomoth: {ab: 'Shield Dust'},
  ...
  Furret: {ab: 'Run Away'},
  Girafarig: {ab: 'Inner Focus'},
  Gligar: {ab: 'Hyper Cutter'},
  Granbull: {ab: 'Intimidate'},
  Heracross: {ab: 'Swarm'},
  Hitmontop: {ab: 'Intimidate'},
  'Ho-Oh': {ab: 'Pressure'},
  Hoothoot: {ab: 'Insomnia'},
  Hoppip: {ab: 'Chlorophyll'},
  Houndoom: {ab: 'Early Bird'},
  Houndour: {ab: 'Early Bird'},
  ...
  Lugia: {ab: 'Pressure'},
  Magby: {ab: 'Flame Body'},
  Magcargo: {ab: 'Magma Armor'},
  Mantine: {ab: 'Swift Swim'},
  Mareep: {ab: 'Static'},
  Marill: {ab: 'Thick Fat'},
  ...
  Natu: {ab: 'Synchronize'},
  Noctowl: {ab: 'Insomnia'},
  Octillery: {ab: 'Suction Cups'},
  Phanpy: {ab: 'Pickup'},
  Pichu: {ab: 'Static'},
  Piloswine: {ab: 'Oblivious'},
  Pineco: {ab: 'Sturdy'},
  ...
  Slowking: {ab: 'Oblivious'},
  Slugma: {ab: 'Magma Armor'},
  Smeargle: {ab: 'Own Tempo'},
  Smoochum: {ab: 'Oblivious'},
  ...
  Castform: {
    ...
    weightkg: 0.8,
    ab: 'Forecast',
    formes: ['Castform', 'Castform-Rainy', 'Castform-Snowy', 'Castform-Sunny'],
  },
  'Castform-Rainy': {
    t1: 'Water',
    bs: {hp: 70, at: 70, df: 70, sa: 70, sd: 70, sp: 70},
...
const DPP_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Cherrim: {
    ...
    weightkg: 9.3,
    ab: 'Flower Gift',
    formes: ['Cherrim', 'Cherrim-Sunshine'],
  },
  'Cherrim-Sunshine': {
    t1: 'Grass',
    bs: {hp: 70, at: 60, df: 70, sa: 87, sd: 78, sp: 85},
...
const BW_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Basculin: {
    ...
    weightkg: 18,
    ab: 'Reckless',
    formes: ['Basculin', 'Basculin-Blue-Striped'],
  },
  ...
  Genesect: {
    ...
    ab: 'Download',
    gender: 'N',
    formes: ['Genesect', 'Genesect-Burn', 'Genesect-Chill', 'Genesect-Douse', 'Genesect-Shock'],
  },
  'Genesect-Burn': {
    t1: 'Bug',
    t2: 'Steel',
...
const XY_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Vivillon: {
    ...
    weightkg: 17,
    ab: 'Shield Dust',
    formes: ['Vivillon', 'Vivillon-Fancy', 'Vivillon-Pokeball'],
  },
  'Vivillon-Fancy': {
    t1: 'Bug',
    t2: 'Flying',
...
const SM_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Eevee: {formes: ['Eevee', 'Eevee-Starter']},
  Electrode: {bs: {sp: 150}},
  ...
  // Meltan does NOT benefit from Eviolite and should not have canEvolve: true (credit: Anubis)
  ...
  Mimikyu: {
    ...
    weightkg: 0.7,
    formes: ['Mimikyu', 'Mimikyu-Busted', 'Mimikyu-Busted-Totem', 'Mimikyu-Totem'],
    ab: 'Disguise',
  },
  'Mimikyu-Busted': {
    t1: 'Ghost',
...
const SS_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Charizard: {formes: ['Charizard', 'Charizard-Gmax', 'Charizard-Mega-X', 'Charizard-Mega-Y']},
  Corsola: {formes: ['Corsola', 'Corsola-Galar']},
  Darmanitan: {
    formes: ['Darmanitan', 'Darmanitan-Galar', 'Darmanitan-Galar-Zen', 'Darmanitan-Zen'],
  },
  ...
  Gengar: {formes: ['Gengar', 'Gengar-Gmax', 'Gengar-Mega']},
  ...
  'Mr. Mime': {formes: ['Mr. Mime', 'Mr. Mime-Galar']},
  Pikachu: {
    formes: [
      'Pikachu',
      'Pikachu-Alola',
  ...
  Polteageist: {
    ...
    weightkg: 0.4,
    ab: 'Weak Armor',
    formes: ['Polteageist', 'Polteageist-Antique'],
    gender: 'N',
  },
  'Polteageist-Antique': {
    t1: 'Ghost',
  ...
  Sinistea: {
    ...
    ab: 'Weak Armor',
    canEvolve: true,
    formes: ['Sinistea', 'Sinistea-Antique'],
    gender: 'N',
  },
  'Sinistea-Antique': {
    t1: 'Ghost',
  ...
  Toxtricity: {
    ...
    weightkg: 40,
    ab: 'Punk Rock',
    formes: ['Toxtricity', 'Toxtricity-Gmax', 'Toxtricity-Low-Key', 'Toxtricity-Low-Key-Gmax'],
  },
  'Toxtricity-Gmax': {
    t1: 'Electric',
    t2: 'Poison',
