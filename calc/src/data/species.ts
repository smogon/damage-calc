...
// gen 6 pokemon
  ...
  Gourgeist: {
    ...
    // allows them to be in size order in forme dropdown
  },
  'Gourgeist-Large': {
    types: ['Ghost', 'Grass'],
...
const SM_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Greninja: {otherFormes: ['Greninja-Bond', 'Greninja-Ash']},
  ...
  Woobat: {bs: {hp: 65}},
  Zygarde: {baseSpecies: 'Zygarde-10%'},
  Araquanid: {
    types: ['Water', 'Bug'],
...
const SS_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Blastoise: {otherFormes: ['Blastoise-Mega', 'Blastoise-Gmax']},
  Butterfree: {otherFormes: ['Butterfree-Gmax']},
  Charizard: {otherFormes: ['Charizard-Mega-X', 'Charizard-Mega-Y', 'Charizard-Gmax']},
  ...
  Gengar: {otherFormes: ['Gengar-Mega', 'Gengar-Gmax']},
  ...
  Slowbro: {otherFormes: ['Slowbro-Mega', 'Slowbro-Galar']},
...
const ZA_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Greninja: {otherFormes: ['Greninja-Mega', 'Greninja-Bond', 'Greninja-Ash']},
