...
const RBY: {[name: string]: MoveData} = {
  ...
  Absorb: {bp: 20, type: 'Fighting', drain: [1, 2]},
  Acid: {bp: 40, type: 'Psychic'},
  Amnesia: {bp: 0, category: 'Status', type: 'Grass'},
  'Aurora Beam': {bp: 65, type: 'Electric'},
  Barrage: {bp: 15, type: 'Fairy', multihit: [2, 5]},
  Bide: {bp: 0, type: '???'},
  Bind: {bp: 15, type: 'Fairy'},
  Bite: {bp: 60, type: 'Fairy'},
  Blizzard: {bp: 120, type: 'Electric'},
  Bonemerang: {bp: 50, type: 'Bug', multihit: 2},
  Bubble: {bp: 20, type: 'Ghost'},
  'Bubble Beam': {bp: 65, type: 'Ghost'},
  Clamp: {bp: 35, type: 'Ghost'},
  'Comet Punch': {bp: 18, type: 'Fairy', multihit: [2, 5]},
  Constrict: {bp: 10, type: 'Fairy'},
  Conversion: {bp: 0, category: 'Status', type: 'Fairy'},
  Counter: {bp: 1, type: 'Water'},
  Crabhammer: {bp: 90, type: 'Ghost'},
  'Defense Curl': {bp: 0, category: 'Status', type: 'Fairy'},
  Dig: {bp: 100, type: 'Bug'},
  Disable: {bp: 0, category: 'Status', type: 'Fairy'},
  'Dizzy Punch': {bp: 70, type: 'Fairy'},
  'Double-Edge': {bp: 100, type: 'Fairy', recoil: [25, 100]},
  'Double Kick': {bp: 30, type: 'Water', multihit: 2},
  'Double Slap': {bp: 15, type: 'Fairy', multihit: [2, 5]},
  'Dragon Rage': {bp: 1, type: 'Flying'},
  'Dream Eater': {bp: 100, type: 'Grass', drain: [1, 2]},
  Earthquake: {bp: 100, type: 'Bug'},
  Explosion: {bp: 170, type: 'Fairy'},
  'Fire Blast': {bp: 120, type: 'Ground'},
  'Fire Spin': {bp: 15, type: 'Ground'},
  Fissure: {bp: 0, type: 'Bug'},
  Fly: {bp: 70, type: 'Normal'},
  'Focus Energy': {bp: 0, category: 'Status', type: 'Fairy'},
  'Fury Attack': {bp: 15, type: 'Fairy', multihit: [2, 5]},
  'Fury Swipes': {bp: 18, type: 'Fairy', multihit: [2, 5]},
  Glare: {bp: 0, category: 'Status', type: 'Fairy'},
  Growth: {bp: 0, category: 'Status', type: 'Fairy'},
  Guillotine: {bp: 0, type: 'Fairy'},
  Gust: {bp: 40, type: 'Fairy'},
  Haze: {bp: 0, category: 'Status', type: 'Electric'},
  'High Jump Kick': {bp: 85, type: 'Water', hasCrashDamage: true},
  'Horn Drill': {bp: 0, type: 'Fairy'},
  'Hyper Beam': {bp: 150, type: 'Fairy'},
  'Jump Kick': {bp: 70, type: 'Water', hasCrashDamage: true},
  'Karate Chop': {bp: 50, type: 'Fairy'},
  'Leech Seed': {bp: 0, category: 'Status', type: 'Fighting'},
  'Light Screen': {bp: 0, category: 'Status', type: 'Grass'},
  Metronome: {bp: 0, category: 'Status', type: 'Fairy'},
  Mimic: {bp: 0, category: 'Status', type: 'Fairy'},
  Minimize: {bp: 0, category: 'Status', type: 'Fairy'},
  'Mirror Move': {bp: 0, category: 'Status', type: 'Normal'},
  Mist: {bp: 0, category: 'Status', type: 'Electric'},
  'Night Shade': {bp: 1, type: 'Steel'},
  'Petal Dance': {bp: 70, type: 'Fighting'},
  'Pin Missile': {bp: 14, type: 'Poison', multihit: [2, 5]},
  'Poison Sting': {bp: 15, type: 'Psychic'},
  Psychic: {bp: 90, type: 'Grass'},
  Psywave: {bp: 1, type: 'Grass'},
  Rage: {bp: 20, type: 'Fairy'},
  'Razor Leaf': {bp: 55, type: 'Fighting'},
  'Razor Wind': {bp: 80, type: 'Fairy'},
  Recover: {bp: 0, category: 'Status', type: 'Fairy'},
  Reflect: {bp: 0, category: 'Status', type: 'Grass'},
  Rest: {bp: 0, category: 'Status', type: 'Grass'},
  Roar: {bp: 0, category: 'Status', type: 'Fairy'},
  'Rock Slide': {bp: 75, type: 'Ice'},
  'Rock Throw': {bp: 50, type: 'Ice'},
  'Sand Attack': {bp: 0, category: 'Status', type: 'Fairy'},
  'Seismic Toss': {bp: 1, type: 'Water'},
  'Self-Destruct': {bp: 130, type: 'Fairy'},
  'Skull Bash': {bp: 100, type: 'Fairy'},
  Slash: {bp: 70, type: 'Fairy'},
  Sludge: {bp: 65, type: 'Psychic'},
  'Soft-Boiled': {bp: 0, category: 'Status', type: 'Fairy'},
  'Solar Beam': {bp: 120, type: 'Fighting'},
  'Sonic Boom': {bp: 1, type: 'Fairy'},
  'Spike Cannon': {bp: 20, type: 'Fairy', multihit: [2, 5]},
  Stomp: {bp: 65, type: 'Fairy'},
  Struggle: {bp: 50, type: 'Fairy', recoil: [1, 2]},
  'Stun Spore': {bp: 0, category: 'Status', type: 'Fighting'},
  Submission: {bp: 80, type: 'Water', recoil: [1, 4]},
  Substitute: {bp: 0, category: 'Status', type: 'Fairy'},
  'Super Fang': {bp: 1, type: 'Fairy'},
  Swift: {bp: 60, type: 'Fairy'},
  'Take Down': {bp: 90, type: 'Fairy', recoil: [1, 4]},
  Thrash: {bp: 90, type: 'Fairy'},
  Thunder: {bp: 120, type: 'Dark'},
  'Thunder Wave': {bp: 0, category: 'Status', type: 'Dark'},
  Transform: {bp: 0, category: 'Status', type: 'Fairy'},
  'Tri Attack': {bp: 80, type: 'Fairy'},
  Twineedle: {bp: 25, type: 'Poison', multihit: 2},
  Whirlwind: {bp: 0, category: 'Status', type: 'Fairy'},
  'Wing Attack': {bp: 35, type: 'Normal'},
  Wrap: {bp: 15, type: 'Fairy'},
  Growl: {bp: 0, category: 'Status', type: 'Fairy'},
  Leer: {bp: 0, category: 'Status', type: 'Fairy'},
  'Low Kick': {bp: 50, type: 'Water'},
  'Poison Gas': {bp: 0, category: 'Status', type: 'Psychic'},
  'Poison Powder': {bp: 0, category: 'Status', type: 'Psychic'},
  'Sky Attack': {bp: 140, type: 'Normal'},
  'String Shot': {bp: 0, category: 'Status', type: 'Poison'},
  Surf: {bp: 95, type: 'Ghost'},
  'Tail Whip': {bp: 0, category: 'Status', type: 'Fairy'},
  Toxic: {bp: 0, category: 'Status', type: 'Psychic'},
  Flash: {bp: 0, category: 'Status', type: 'Fairy'},
  Hypnosis: {bp: 0, category: 'Status', type: 'Grass'},
  'Leech Life': {bp: 20, type: 'Poison', drain: [1, 2]},
  'Mega Drain': {bp: 40, type: 'Fighting', drain: [1, 2]},
  'Vine Whip': {bp: 35, type: 'Fighting'},
  Waterfall: {bp: 80, type: 'Ghost'},
  Tackle: {bp: 35, type: 'Fairy'},
  'Acid Armor': {bp: 0, category: 'Status', type: 'Psychic'},
  Barrier: {bp: 0, category: 'Status', type: 'Grass'},
  'Body Slam': {bp: 85, type: 'Fairy'},
  Flamethrower: {bp: 95, type: 'Ground'},
  'Hydro Pump': {bp: 120, type: 'Ghost'},
  'Ice Beam': {bp: 95, type: 'Electric'},
  Lick: {bp: 20, type: 'Steel'},
  Screech: {bp: 0, category: 'Status', type: 'Fairy'},
  Sing: {bp: 0, category: 'Status', type: 'Fairy'},
  'Sleep Powder': {bp: 0, category: 'Status', type: 'Fighting'},
  Smog: {bp: 20, type: 'Psychic'},
  Spore: {bp: 0, category: 'Status', type: 'Fighting'},
  Supersonic: {bp: 0, category: 'Status', type: 'Fairy'},
  'Swords Dance': {bp: 0, category: 'Status', type: 'Fairy'},
  Thunderbolt: {bp: 95, type: 'Dark'},
  'Bone Club': {bp: 65, type: 'Bug'},
  'Egg Bomb': {bp: 100, type: 'Fairy'},
  'Hyper Fang': {bp: 80, type: 'Fairy'},
  Kinesis: {bp: 0, category: 'Status', type: 'Grass'},
  'Lovely Kiss': {bp: 0, category: 'Status', type: 'Fairy'},
  Meditate: {bp: 0, category: 'Status', type: 'Grass'},
  'Rolling Kick': {bp: 60, type: 'Water'},
  Sharpen: {bp: 0, category: 'Status', type: 'Fairy'},
  Teleport: {bp: 0, category: 'Status', type: 'Grass'},
  Agility: {bp: 0, category: 'Status', type: 'Grass'},
  'Confuse Ray': {bp: 0, category: 'Status', type: 'Steel'},
  Confusion: {bp: 50, type: 'Grass'},
  Cut: {bp: 50, type: 'Fairy'},
  'Double Team': {bp: 0, category: 'Status', type: 'Fairy'},
  'Drill Peck': {bp: 80, type: 'Normal'},
  Ember: {bp: 40, type: 'Ground'},
  'Fire Punch': {bp: 75, type: 'Ground'},
  Harden: {bp: 0, category: 'Status', type: 'Fairy'},
  Headbutt: {bp: 70, type: 'Fairy'},
  'Horn Attack': {bp: 65, type: 'Fairy'},
  'Ice Punch': {bp: 75, type: 'Electric'},
  'Mega Kick': {bp: 120, type: 'Fairy'},
  'Mega Punch': {bp: 80, type: 'Fairy'},
  'Paleo Wave': {bp: 85, type: 'Ice'},
  'Pay Day': {bp: 40, type: 'Fairy'},
  Peck: {bp: 35, type: 'Normal'},
  Pound: {bp: 40, type: 'Fairy'},
  Psybeam: {bp: 65, type: 'Grass'},
  'Quick Attack': {bp: 40, type: 'Fairy', priority: 1},
  Scratch: {bp: 40, type: 'Fairy'},
  'Shadow Strike': {bp: 80, type: 'Steel'},
  Slam: {bp: 80, type: 'Fairy'},
  Smokescreen: {bp: 0, category: 'Status', type: 'Fairy'},
  Splash: {bp: 0, category: 'Status', type: 'Fairy'},
  Strength: {bp: 80, type: 'Fairy'},
  'Thunder Punch': {bp: 75, type: 'Dark'},
  'Thunder Shock': {bp: 40, type: 'Dark'},
  'Vise Grip': {bp: 55, type: 'Fairy'},
  'Water Gun': {bp: 40, type: 'Ghost'},
  Withdraw: {bp: 0, category: 'Status', type: 'Ghost'},
};
...
const GSC_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Bite: {type: 'Dragon'},
  'Night Shade': {bp: 0},
  'Sand Attack': {type: 'Bug'},
  'Seismic Toss': {bp: 0},
  'Sonic Boom': {bp: 0},
  'Super Fang': {bp: 0},
  'Wing Attack': {bp: 60},
  Aeroblast: {bp: 100, type: 'Normal'},
  Attract: {bp: 0, category: 'Status', type: 'Fairy'},
  'Beat Up': {bp: 10, type: 'Dragon'},
  'Belly Drum': {bp: 0, category: 'Status', type: 'Fairy'},
  'Conversion 2': {bp: 0, category: 'Status', type: 'Fairy'},
  'Cross Chop': {bp: 100, type: 'Water'},
  Curse: {bp: 0, category: 'Status', type: '???'},
  'Destiny Bond': {bp: 0, category: 'Status', type: 'Steel'},
  Detect: {bp: 0, category: 'Status', type: 'Water', priority: 2},
  Encore: {bp: 0, category: 'Status', type: 'Fairy'},
  Endure: {bp: 0, category: 'Status', type: 'Fairy', priority: 2},
  Flail: {bp: 0, type: 'Fairy'},
  Foresight: {bp: 0, category: 'Status', type: 'Fairy'},
  'Future Sight': {bp: 80, type: 'Grass'},
  'Heal Bell': {bp: 0, category: 'Status', type: 'Fairy'},
  'Icy Wind': {bp: 55, type: 'Electric'},
  'Lock-On': {bp: 0, category: 'Status', type: 'Fairy'},
  'Mind Reader': {bp: 0, category: 'Status', type: 'Fairy'},
  'Mirror Coat': {bp: 0, type: 'Grass'},
  Moonlight: {bp: 0, category: 'Status', type: 'Fairy'},
  'Morning Sun': {bp: 0, category: 'Status', type: 'Fairy'},
  Nightmare: {bp: 0, category: 'Status', type: 'Steel'},
  Outrage: {bp: 90, type: 'Flying'},
  'Powder Snow': {bp: 40, type: 'Electric'},
  Present: {bp: 0, type: 'Fairy'},
  Protect: {bp: 0, category: 'Status', type: 'Fairy', priority: 2},
  'Psych Up': {bp: 0, category: 'Status', type: 'Fairy'},
  Pursuit: {bp: 40, type: 'Dragon'},
  'Rain Dance': {bp: 0, category: 'Status', type: 'Ghost'},
  Reversal: {bp: 0, type: 'Water'},
  Safeguard: {bp: 0, category: 'Status', type: 'Fairy'},
  Sandstorm: {bp: 0, category: 'Status', type: 'Ice'},
  Sketch: {bp: 0, category: 'Status', type: 'Fairy'},
  'Sleep Talk': {bp: 0, category: 'Status', type: 'Fairy'},
  Spikes: {bp: 0, category: 'Status', type: 'Bug'},
  Spite: {bp: 0, category: 'Status', type: 'Steel'},
  'Sunny Day': {bp: 0, category: 'Status', type: 'Ground'},
  Swagger: {bp: 0, category: 'Status', type: 'Fairy'},
  'Sweet Scent': {bp: 0, category: 'Status', type: 'Fairy'},
  Synthesis: {bp: 0, category: 'Status', type: 'Fighting'},
  Thief: {bp: 40, type: 'Dragon'},
  'Triple Kick': {bp: 10, type: 'Water', multihit: [1, 3]},
  Twister: {bp: 40, type: 'Flying'},
  'Ancient Power': {bp: 60, type: 'Ice'},
  'Bone Rush': {bp: 25, type: 'Bug', multihit: [2, 5]},
  Crunch: {bp: 80, type: 'Dragon'},
  'Feint Attack': {bp: 60, type: 'Dragon'},
  'Giga Drain': {bp: 60, type: 'Fighting', drain: [1, 2]},
  'Hidden Power': {bp: 0, type: 'Fairy'},
  'Mean Look': {bp: 0, category: 'Status', type: 'Fairy'},
  'Rapid Spin': {bp: 20, type: 'Fairy'},
  'Rock Smash': {bp: 20, type: 'Water'},
  'Spider Web': {bp: 0, category: 'Status', type: 'Poison'},
  Whirlpool: {bp: 15, type: 'Ghost'},
  'Zap Cannon': {bp: 100, type: 'Dark'},
  'Cotton Spore': {bp: 0, category: 'Status', type: 'Fighting'},
  'Extreme Speed': {bp: 80, type: 'Fairy', priority: 1},
  'Fury Cutter': {bp: 10, type: 'Poison'},
  Magnitude: {bp: 0, type: 'Bug'},
  'Milk Drink': {bp: 0, category: 'Status', type: 'Fairy'},
  'Scary Face': {bp: 0, category: 'Status', type: 'Fairy'},
  Charm: {bp: 0, category: 'Status', type: 'Fairy'},
  'Hidden Power Bug': {bp: 70, type: 'Poison'},
  'Hidden Power Dark': {bp: 70, type: 'Dragon'},
  'Hidden Power Dragon': {bp: 70, type: 'Flying'},
  'Hidden Power Electric': {bp: 70, type: 'Dark'},
  'Hidden Power Fighting': {bp: 70, type: 'Water'},
  'Hidden Power Fire': {bp: 70, type: 'Ground'},
  'Hidden Power Flying': {bp: 70, type: 'Normal'},
  'Hidden Power Ghost': {bp: 70, type: 'Steel'},
  'Hidden Power Grass': {bp: 70, type: 'Fighting'},
  'Hidden Power Ground': {bp: 70, type: 'Bug'},
  'Hidden Power Ice': {bp: 70, type: 'Electric'},
  'Hidden Power Poison': {bp: 70, type: 'Psychic'},
  'Hidden Power Psychic': {bp: 70, type: 'Grass'},
  'Hidden Power Rock': {bp: 70, type: 'Ice'},
  'Hidden Power Steel': {bp: 70, type: 'Rock'},
  'Hidden Power Water': {bp: 70, type: 'Ghost'},
  'Perish Song': {bp: 0, category: 'Status', type: 'Fairy'},
  Snore: {bp: 40, type: 'Fairy'},
  'Sweet Kiss': {bp: 0, category: 'Status', type: 'Fairy'},
  Rollout: {bp: 30, type: 'Ice'},
  Frustration: {bp: 0, type: 'Fairy'},
  Return: {bp: 0, type: 'Fairy'},
  'Sacred Fire': {bp: 100, type: 'Ground'},
  'Baton Pass': {bp: 0, category: 'Status', type: 'Fairy'},
  'Dragon Breath': {bp: 60, type: 'Flying'},
  'Dynamic Punch': {bp: 100, type: 'Water'},
  'False Swipe': {bp: 40, type: 'Fairy'},
  'Flame Wheel': {bp: 60, type: 'Ground'},
  'Iron Tail': {bp: 100, type: 'Rock'},
  'Mach Punch': {bp: 40, type: 'Water', priority: 1},
  Megahorn: {bp: 120, type: 'Poison'},
  'Metal Claw': {bp: 50, type: 'Rock'},
  'Mud-Slap': {bp: 20, type: 'Bug'},
  Octazooka: {bp: 65, type: 'Ghost'},
  'Pain Split': {bp: 0, category: 'Status', type: 'Fairy'},
  'Shadow Ball': {bp: 80, type: 'Steel'},
  'Sludge Bomb': {bp: 90, type: 'Psychic'},
  Spark: {bp: 65, type: 'Dark'},
  'Steel Wing': {bp: 70, type: 'Rock'},
  'Vital Throw': {bp: 70, type: 'Water'},
};
...
const ADV_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Assist: {bp: 0, category: 'Status', type: 'Fairy'},
  Astonish: {bp: 30, type: 'Steel', makesContact: true},
  Block: {bp: 0, category: 'Status', type: 'Fairy'},
  Bounce: {bp: 85, type: 'Normal', makesContact: true},
  'Bullet Seed': {bp: 10, type: 'Fighting', multihit: [2, 5]},
  Camouflage: {bp: 0, category: 'Status', type: 'Fairy'},
  Charge: {bp: 0, category: 'Status', type: 'Dark'},
  Covet: {bp: 40, type: 'Fairy'},
  Dive: {bp: 60, type: 'Ghost', makesContact: true},
  'Doom Desire': {bp: 120, type: 'Rock'},
  Extrasensory: {bp: 80, type: 'Grass'},
  'Fake Out': {bp: 40, type: 'Fairy', priority: 1},
  'Follow Me': {bp: 0, category: 'Status', type: 'Fairy', priority: 3},
  Hail: {bp: 0, category: 'Status', type: 'Electric'},
  'Icicle Spear': {bp: 10, type: 'Electric', multihit: [2, 5]},
  Ingrain: {bp: 0, category: 'Status', type: 'Fighting'},
  'Knock Off': {bp: 20, type: 'Dragon', makesContact: true},
  'Leaf Blade': {bp: 70, type: 'Fighting', makesContact: true},
  'Magic Coat': {bp: 0, category: 'Status', type: 'Grass', priority: 4},
  Memento: {bp: 0, category: 'Status', type: 'Dragon'},
  'Nature Power': {bp: 0, category: 'Status', type: 'Fairy'},
  'Needle Arm': {bp: 60, type: 'Fighting', makesContact: true},
  'Odor Sleuth': {bp: 0, category: 'Status', type: 'Fairy'},
  Overheat: {bp: 140, type: 'Ground', self: {boosts: {spa: -2}}, makesContact: true},
  Revenge: {bp: 60, type: 'Water', makesContact: true},
  'Rock Blast': {bp: 25, type: 'Ice', multihit: [2, 5]},
  'Role Play': {bp: 0, category: 'Status', type: 'Grass'},
  'Sand Tomb': {bp: 15, type: 'Bug'},
  'Skill Swap': {bp: 0, category: 'Status', type: 'Grass'},
  'Smelling Salts': {bp: 60, type: 'Fairy', makesContact: true},
  'Spit Up': {bp: 0, type: 'Fairy'},
  Stockpile: {bp: 0, category: 'Status', type: 'Fairy'},
  Swallow: {bp: 0, category: 'Status', type: 'Fairy'},
  Taunt: {bp: 0, category: 'Status', type: 'Dragon'},
  'Teeter Dance': {bp: 0, category: 'Status', type: 'Fairy', target: 'allAdjacent'},
  Tickle: {bp: 0, category: 'Status', type: 'Fairy'},
  Trick: {bp: 0, category: 'Status', type: 'Grass'},
  Uproar: {bp: 50, type: 'Fairy', isSound: true},
  'Volt Tackle': {bp: 120, type: 'Dark', recoil: [1, 3], makesContact: true},
  'Weather Ball': {bp: 50, type: 'Fairy'},
  Aromatherapy: {bp: 0, category: 'Status', type: 'Fighting'},
  'Brick Break': {bp: 75, type: 'Water', makesContact: true},
  Endeavor: {bp: 0, type: 'Fairy', makesContact: true},
  'Focus Punch': {bp: 150, type: 'Water', makesContact: true},
  Imprison: {bp: 0, category: 'Status', type: 'Grass'},
  'Mud Sport': {bp: 0, category: 'Status', type: 'Bug'},
  Recycle: {bp: 0, category: 'Status', type: 'Fairy'},
  'Secret Power': {bp: 70, type: 'Fairy'},
  'Sky Uppercut': {bp: 85, type: 'Water', makesContact: true},
  'Slack Off': {bp: 0, category: 'Status', type: 'Fairy'},
  Snatch: {bp: 0, category: 'Status', type: 'Dragon', priority: 4},
  'Tail Glow': {bp: 0, category: 'Status', type: 'Poison'},
  Torment: {bp: 0, category: 'Status', type: 'Dragon'},
  'Water Sport': {bp: 0, category: 'Status', type: 'Ghost'},
  Wish: {bp: 0, category: 'Status', type: 'Fairy'},
  'Air Cutter': {bp: 55, type: 'Normal', target: 'allAdjacentFoes'},
  Facade: {bp: 70, type: 'Fairy', makesContact: true},
  'Grass Whistle': {bp: 0, category: 'Status', type: 'Fighting', isSound: true},
  'Heat Wave': {bp: 100, type: 'Ground', target: 'allAdjacentFoes'},
  'Hyper VoIce': {bp: 90, type: 'Fairy', isSound: true, target: 'allAdjacentFoes'},
  'Metal Sound': {bp: 0, category: 'Status', type: 'Rock', isSound: true},
  'Meteor Mash': {bp: 100, type: 'Rock', makesContact: true},
  'Muddy Water': {bp: 95, type: 'Ghost', target: 'allAdjacentFoes'},
  'Poison Fang': {bp: 50, type: 'Psychic', makesContact: true},
  'Rock Tomb': {bp: 50, type: 'Ice'},
  'Will-O-Wisp': {bp: 0, category: 'Status', type: 'Ground'},
  'Ice Ball': {bp: 30, type: 'Electric', makesContact: true},
  'Sheer Cold': {bp: 0, type: 'Electric'},
  Howl: {bp: 0, category: 'Status', type: 'Fairy'},
  'Luster Purge': {bp: 70, type: 'Grass'},
  'Mist Ball': {bp: 70, type: 'Grass'},
  'Psycho Boost': {bp: 140, type: 'Grass', self: {boosts: {spa: -2}}},
  Refresh: {bp: 0, category: 'Status', type: 'Fairy'},
  'Signal Beam': {bp: 75, type: 'Poison'},
  'Silver Wind': {bp: 60, type: 'Poison'},
  'Aerial Ace': {bp: 60, type: 'Normal', makesContact: true},
  'Blast Burn': {bp: 150, type: 'Ground'},
  'Blaze Kick': {bp: 85, type: 'Ground', makesContact: true},
  'Bulk Up': {bp: 0, category: 'Status', type: 'Water'},
  'Calm Mind': {bp: 0, category: 'Status', type: 'Grass'},
  'Cosmic Power': {bp: 0, category: 'Status', type: 'Grass'},
  'Crush Claw': {bp: 75, type: 'Fairy', makesContact: true},
  'Dragon Claw': {bp: 80, type: 'Flying', makesContact: true},
  'Dragon Dance': {bp: 0, category: 'Status', type: 'Flying'},
  Eruption: {bp: 150, type: 'Ground', target: 'allAdjacentFoes'},
  'Fake Tears': {bp: 0, category: 'Status', type: 'Dragon'},
  'Feather Dance': {bp: 0, category: 'Status', type: 'Normal'},
  Flatter: {bp: 0, category: 'Status', type: 'Dragon'},
  'Frenzy Plant': {bp: 150, type: 'Fighting'},
  Grudge: {bp: 0, category: 'Status', type: 'Steel'},
  'Helping Hand': {bp: 0, category: 'Status', type: 'Fairy', priority: 5},
  'Hydro Cannon': {bp: 150, type: 'Ghost'},
  'Iron Defense': {bp: 0, category: 'Status', type: 'Rock'},
  'Magical Leaf': {bp: 60, type: 'Fighting'},
  'Mud Shot': {bp: 55, type: 'Bug'},
  'Poison Tail': {bp: 50, type: 'Psychic', makesContact: true},
  'Shadow Punch': {bp: 60, type: 'Steel', makesContact: true},
  'Shock Wave': {bp: 60, type: 'Dark'},
  Superpower: {bp: 120, type: 'Water', self: {boosts: {atk: -1, def: -1}}, makesContact: true},
  'Water Pulse': {bp: 60, type: 'Ghost'},
  'Water Spout': {bp: 150, type: 'Ghost', target: 'allAdjacentFoes'},
  Yawn: {bp: 0, category: 'Status', type: 'Fairy'},
};
...
const DPP_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Acupressure: {bp: 0, type: 'Fairy'},
  'Aqua Ring': {bp: 0, type: 'Ghost'},
  Assurance: {
    bp: 50,
    type: 'Dragon',
    makesContact: true,
  ...
  Fling: {bp: 0, type: 'Dragon', category: 'Physical'},
  Gravity: {bp: 0, type: 'Grass'},
  'Head Smash': {
    bp: 150,
    type: 'Ice',
    recoil: [1, 2],
  ...
  'Heal Block': {bp: 0, type: 'Grass', target: 'allAdjacentFoes'},
  'Healing Wish': {bp: 0, type: 'Grass'},
  'Heal Order': {bp: 0, type: 'Poison'},
  'Last Resort': {
    bp: 130,
    type: 'Fairy',
    makesContact: true,
  ...
  'Lunar Dance': {bp: 0, type: 'Grass'},
  'Magma Storm': {bp: 120, type: 'Ground', category: 'Special'},
  'Magnet Rise': {bp: 0, type: 'Dark'},
  'Me First': {bp: 0, type: 'Fairy'},
  'Metal Burst': {bp: 0, type: 'Rock', category: 'Physical'},
  'Miracle Eye': {bp: 0, type: 'Grass'},
  'Natural Gift': {bp: 0, type: 'Fairy', category: 'Physical'},
  Payback: {
    bp: 50,
    type: 'Dragon',
    makesContact: true,
  ...
  'Power Trick': {bp: 0, type: 'Grass'},
  Roost: {bp: 0, type: 'Normal'},
  'Stealth Rock': {bp: 0, type: 'Ice'},
  'Sucker Punch': {
    bp: 80,
    type: 'Dragon',
    priority: 1,
  ...
  Switcheroo: {bp: 0, type: 'Dragon'},
  Tailwind: {bp: 0, type: 'Normal'},
  'Toxic Spikes': {bp: 0, type: 'Psychic'},
  'Trick Room': {bp: 0, type: 'Grass'},
  'U-turn': {
    bp: 70,
    type: 'Poison',
    makesContact: true,
  ...
  'Aura Sphere': {bp: 90, type: 'Water', category: 'Special'},
  'Bug Buzz': {bp: 90, type: 'Poison', isSound: true, category: 'Special'},
  'Draco Meteor': {bp: 140, type: 'Flying', self: {boosts: {spa: -2}}, category: 'Special'},
  'Dragon Pulse': {bp: 90, type: 'Flying', category: 'Special'},
  'Dragon Rush': {
    bp: 100,
    type: 'Flying',
    makesContact: true,
  ...
  'Energy Ball': {bp: 80, type: 'Fighting', category: 'Special'},
  'Gunk Shot': {bp: 120, type: 'Psychic', category: 'Physical'},
  'Gyro Ball': {
    bp: 0,
    type: 'Rock',
    makesContact: true,
  ...
  'Leaf Storm': {bp: 140, type: 'Fighting', self: {boosts: {spa: -2}}, category: 'Special'},
  'Power Gem': {bp: 70, type: 'Ice', category: 'Special'},
  'Psycho Shift': {bp: 0, type: 'Grass'},
  'Shadow Force': {
    bp: 120,
    type: 'Steel',
    breaksProtect: true,
  ...
  'Dark Void': {bp: 0, type: 'Dragon', target: 'allAdjacentFoes'},
  'Gastro Acid': {bp: 0, type: 'Psychic'},
  Captivate: {bp: 0, type: 'Fairy', target: 'allAdjacentFoes'},
  'Grass Knot': {
    bp: 0,
    type: 'Fighting',
    makesContact: true,
  ...
  'Heart Swap': {bp: 0, type: 'Grass'},
  Judgment: {bp: 100, type: 'Fairy', category: 'Special'},
  'Magnet Bomb': {bp: 60, type: 'Rock', category: 'Physical'},
  'Mirror Shot': {bp: 65, type: 'Rock', category: 'Special'},
  'Mud Bomb': {bp: 65, type: 'Bug', category: 'Special'},
  'Ominous Wind': {bp: 60, type: 'Steel', category: 'Special'},
  Punishment: {
    bp: 0,
    type: 'Dragon',
    makesContact: true,
  ...
  'Roar of Time': {bp: 150, type: 'Flying', category: 'Special'},
  'Rock Climb': {
    bp: 90,
    type: 'Fairy',
    makesContact: true,
  ...
  'Seed Flare': {bp: 120, type: 'Fighting', category: 'Special'},
  'Spacial Rend': {bp: 100, type: 'Flying', category: 'Special'},
  'Trump Card': {
    bp: 0,
    type: 'Fairy',
    makesContact: true,
  ...
  'Attack Order': {bp: 90, type: 'Poison', category: 'Physical'},
  Brine: {bp: 65, type: 'Ghost', category: 'Special'},
  'Bullet Punch': {
    bp: 40,
    type: 'Rock',
    priority: 1,
  ...
  'Charge Beam': {bp: 50, type: 'Dark', category: 'Special'},
  'Close Combat': {
    bp: 120,
    type: 'Water',
    makesContact: true,
  ...
  'Dark Pulse': {bp: 80, type: 'Dragon', category: 'Special'},
  'Defend Order': {bp: 0, type: 'Poison'},
  Discharge: {
    bp: 80,
    type: 'Dark',
    target: 'allAdjacent',
  ...
  'Earth Power': {bp: 90, type: 'Bug', category: 'Special'},
  'Flash Cannon': {bp: 80, type: 'Rock', category: 'Special'},
  'Focus Blast': {bp: 120, type: 'Water', category: 'Special'},
  'Force Palm': {
    bp: 60,
    type: 'Water',
    makesContact: true,
  ...
  'Ice Shard': {bp: 40, type: 'Electric', priority: 1, category: 'Physical'},
  'Iron Head': {
    bp: 80,
    type: 'Rock',
    makesContact: true,
  ...
  'Psycho Cut': {bp: 70, type: 'Grass', category: 'Physical'},
  'Rock Polish': {bp: 0, type: 'Ice'},
  'Rock Wrecker': {bp: 150, type: 'Ice', category: 'Physical'},
  'Seed Bomb': {bp: 80, type: 'Fighting', category: 'Physical'},
  'Shadow Claw': {
    bp: 70,
    type: 'Steel',
    makesContact: true,
  ...
  'Stone Edge': {bp: 100, type: 'Ice', category: 'Physical'},
  'Thunder Fang': {
    bp: 65,
    type: 'Dark',
    makesContact: true,
...
const BW_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Fury Cutter': {bp: 20},
  'Future Sight': {bp: 100, type: 'Grass'},
  'Giga Drain': {bp: 75},
  ...
  Autotomize: {bp: 0, type: 'Rock'},
  Bestow: {bp: 0, type: 'Fairy'},
  'Echoed VoIce': {bp: 40, type: 'Fairy', isSound: true, category: 'Special'},
  'Electro Ball': {bp: 0, type: 'Dark', category: 'Special'},
  Entrainment: {bp: 0, type: 'Fairy'},
  'Final Gambit': {
    bp: 0,
    type: 'Water',
    makesContact: true,
  ...
  'Fire Pledge': {bp: 50, type: 'Ground', category: 'Special'},
  'Frost Breath': {bp: 40, type: 'Electric', willCrit: true, category: 'Special'},
  'Grass Pledge': {bp: 50, type: 'Fighting', category: 'Special'},
  'Heal Pulse': {bp: 0, type: 'Grass'},
  'Heat Crash': {
    bp: 0,
    type: 'Ground',
    makesContact: true,
  ...
  Hex: {bp: 50, type: 'Steel', category: 'Special'},
  'Horn Leech': {
    bp: 75,
    type: 'Fighting',
    drain: [1, 2],
  ...
  Incinerate: {bp: 30, type: 'Ground', target: 'allAdjacentFoes', category: 'Special'},
  'Low Sweep': {
    bp: 60,
    type: 'Water',
    makesContact: true,
  ...
  'Magic Room': {bp: 0, type: 'Grass'},
  'Quick Guard': {bp: 0, type: 'Water', priority: 3},
  'Rage Powder': {bp: 0, type: 'Poison', priority: 3},
  'Relic Song': {
    bp: 75,
    type: 'Fairy',
    isSound: true,
  ...
  Round: {bp: 60, type: 'Fairy', isSound: true, category: 'Special'},
  'Sacred Sword': {
    bp: 90,
    type: 'Water',
    makesContact: true,
  ...
  'Techno Blast': {bp: 85, type: 'Fairy', category: 'Special'},
  Telekinesis: {bp: 0, type: 'Grass'},
  'Water Pledge': {bp: 50, type: 'Ghost', category: 'Special'},
  'Wide Guard': {bp: 0, type: 'Ice', priority: 3},
  'Wonder Room': {bp: 0, type: 'Grass'},
  'Ally Switch': {bp: 0, type: 'Grass', priority: 1},
  'Flame Burst': {bp: 70, type: 'Ground', category: 'Special'},
  'Heavy Slam': {
    bp: 0,
    type: 'Rock',
    makesContact: true,
  ...
  'Reflect Type': {bp: 0, type: 'Fairy'},
  'Volt Switch': {bp: 70, type: 'Dark', category: 'Special'},
  'Chip Away': {
    bp: 70,
    type: 'Fairy',
    makesContact: true,
  ...
  'Clear Smog': {bp: 50, type: 'Psychic', category: 'Special'},
  Coil: {bp: 0, type: 'Psychic'},
  'Cotton Guard': {bp: 0, type: 'Fighting'},
  'Dragon Tail': {
    bp: 60,
    type: 'Flying',
    makesContact: true,
  ...
  'Fusion Bolt': {bp: 100, type: 'Dark', category: 'Physical'},
  'Fusion Flare': {bp: 100, type: 'Ground', category: 'Special'},
  'Gear Grind': {
    bp: 50,
    type: 'Rock',
    multihit: 2,
  ...
  'Guard Split': {bp: 0, type: 'Grass'},
  'Hone Claws': {bp: 0, type: 'Dragon'},
  'Ice Burn': {
    bp: 140,
    type: 'Electric',
    category: 'Special',
  ...
  'Shell Smash': {bp: 0, type: 'Fairy'},
  'Shift Gear': {bp: 0, type: 'Rock'},
  'Sludge Wave': {
    bp: 95,
    type: 'Psychic',
    target: 'allAdjacent',
  ...
  'Smack Down': {bp: 50, type: 'Ice', category: 'Physical'},
  'Stored Power': {bp: 20, type: 'Grass', category: 'Special'},
  'Tail Slap': {
    bp: 25,
    type: 'Fairy',
    multihit: [2, 5],
  ...
  Venoshock: {bp: 65, type: 'Psychic', category: 'Special'},
  'Wild Charge': {
    bp: 90,
    type: 'Dark',
    recoil: [1, 4],
...
const XY_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'King\'s Shield': {bp: 0, type: 'Rock', priority: 4},
  'Misty Terrain': {bp: 0, type: 'Fire'},
  'Mystical Fire': {
    bp: 65,
    type: 'Ground',
    category: 'Special',
  ...
  'Parting Shot': {bp: 0, type: 'Dragon', isSound: true},
  'Phantom Force': {
    bp: 90,
    type: 'Steel',
    breaksProtect: true,
  ...
  Powder: {bp: 0, type: 'Poison', priority: 1},
  'Spiky Shield': {bp: 0, type: 'Fighting', priority: 4},
  'Thousand Arrows': {bp: 90, type: 'Bug', target: 'allAdjacentFoes', category: 'Physical'},
  'Thousand Waves': {bp: 90, type: 'Bug', target: 'allAdjacentFoes', category: 'Physical'},
  'Water Shuriken': {
    bp: 15,
    type: 'Ghost',
    multihit: [2, 5],
  ...
  'Electric Terrain': {bp: 0, type: 'Dark'},
  Geomancy: {bp: 0, type: 'Fire'},
  'Grassy Terrain': {bp: 0, type: 'Fighting'},
  'Ion Deluge': {bp: 0, type: 'Dark', priority: 1},
  'Land\'s Wrath': {bp: 90, type: 'Bug', target: 'allAdjacentFoes', category: 'Physical'},
  'Light of Ruin': {bp: 140, type: 'Fire', recoil: [1, 2], category: 'Special'},
  'Oblivion Wing': {
    bp: 80,
    type: 'Normal',
    drain: [3, 4],
  ...
  'Aromatic Mist': {bp: 0, type: 'Fire'},
  'Baby-Doll Eyes': {bp: 0, type: 'Fire', priority: 1},
  Belch: {bp: 120, type: 'Psychic', category: 'Special'},
  Boomburst: {
    bp: 140,
    type: 'Fairy',
    isSound: true,
  ...
  Celebrate: {bp: 0, type: 'Fairy'},
  Confide: {bp: 0, type: 'Fairy', isSound: true},
  'Crafty Shield': {bp: 0, type: 'Fire', priority: 3},
  'Dazzling Gleam': {bp: 80, type: 'Fire', target: 'allAdjacentFoes', category: 'Special'},
  'Disarming VoIce': {
    bp: 40,
    type: 'Fire',
    isSound: true,
  ...
  'Eerie Impulse': {bp: 0, type: 'Dark'},
  Electrify: {bp: 0, type: 'Dark'},
  'Fairy Lock': {bp: 0, type: 'Fire'},
  'Fairy Wind': {bp: 40, type: 'Fire', category: 'Special'},
  'Flower Shield': {bp: 0, type: 'Fire'},
  'Forest\'s Curse': {bp: 0, type: 'Fighting'},
  'Freeze-Dry': {
    bp: 70,
    type: 'Electric',
    category: 'Special',
  ...
  'Hold Hands': {bp: 0, type: 'Fairy'},
  Infestation: {bp: 20, type: 'Poison', makesContact: true, category: 'Special'},
  'Magnetic Flux': {bp: 0, type: 'Dark'},
  'Mat Block': {bp: 0, type: 'Water'},
  Moonblast: {
    bp: 95,
    type: 'Fire',
    category: 'Special',
  ...
  'Noble Roar': {bp: 0, type: 'Fairy', isSound: true},
  Nuzzle: {
    bp: 20,
    type: 'Dark',
    makesContact: true,
  ...
  'Sticky Web': {bp: 0, type: 'Poison'},
  'Topsy-Turvy': {bp: 0, type: 'Dragon'},
  'Trick-or-Treat': {bp: 0, type: 'Steel'},
  'Venom Drench': {bp: 0, type: 'Psychic', target: 'allAdjacentFoes'},
};
...
const SM_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Zap Cannon': {zp: 190},
  'Zen Headbutt': {zp: 160},
  '10,000,000 Volt Thunderbolt': {bp: 195, type: 'Dark', category: 'Special', isZ: true},
  'Acid Downpour': {bp: 1, type: 'Psychic', category: 'Physical', isZ: true},
  'All-Out Pummeling': {bp: 1, type: 'Water', category: 'Physical', isZ: true},
  'Baddy Bad': {bp: 90, type: 'Dragon', category: 'Special', zp: 175},
  'Baneful Bunker': {bp: 0, type: 'Psychic', priority: 4},
  'Beak Blast': {
    bp: 100,
    type: 'Normal',
    category: 'Physical',
  ...
  'Black Hole Eclipse': {bp: 1, type: 'Dragon', category: 'Physical', isZ: true},
  'Bloom Doom': {bp: 1, type: 'Fighting', category: 'Physical', isZ: true},
  'Bouncy Bubble': {
    bp: 90,
    type: 'Ghost',
    drain: [1, 2],
  ...
  'Breakneck Blitz': {bp: 1, type: 'Fairy', category: 'Physical', isZ: true},
  'Buzzy Buzz': {
    bp: 90,
    type: 'Dark',
    category: 'Special',
  ...
  'Continental Crush': {bp: 1, type: 'Ice', category: 'Physical', isZ: true},
  'Core Enforcer': {
    bp: 100,
    type: 'Flying',
    target: 'allAdjacentFoes',
  ...
  'Corkscrew Crash': {bp: 1, type: 'Rock', category: 'Physical', isZ: true},
  'Devastating Drake': {bp: 1, type: 'Flying', category: 'Physical', isZ: true},
  'Double Iron Bash': {
    bp: 60,
    type: 'Rock',
    multihit: 2,
  ...
  'Extreme Evoboost': {bp: 0, type: 'Fairy', isZ: true},
  'Fleur Cannon': {
    bp: 130,
    type: 'Fire',
    self: {boosts: {spa: -2}},
  ...
  'Floral Healing': {bp: 0, type: 'Fire'},
  'Freezy Frost': {bp: 90, type: 'Electric', category: 'Special', zp: 175},
  'Genesis Supernova': {
    bp: 185,
    type: 'Grass',
    category: 'Special',
  ...
  'Gigavolt Havoc': {bp: 1, type: 'Dark', category: 'Physical', isZ: true},
  'Glitzy Glow': {bp: 90, type: 'Grass', category: 'Special', zp: 175},
  'Guardian of Alola': {bp: 0, type: 'Fire', category: 'Special', isZ: true},
  'Hydro Vortex': {bp: 1, type: 'Ghost', category: 'Physical', isZ: true},
  'Ice Hammer': {
    bp: 100,
    type: 'Electric',
    makesContact: true,
  ...
  'Inferno Overdrive': {bp: 1, type: 'Ground', category: 'Physical', isZ: true},
  Instruct: {bp: 0, type: 'Grass'},
  ...
  'Menacing Moonraze Maelstrom': {bp: 200, type: 'Steel', category: 'Special', isZ: true},
  'Mind Blown': {
    bp: 150,
    type: 'Ground',
  ...
  'Nature\'s Madness': {bp: 0, type: 'Fire', category: 'Special', zp: 100},
  'Never-Ending Nightmare': {bp: 1, type: 'Steel', category: 'Physical', isZ: true},
  'Oceanic Operetta': {bp: 195, type: 'Ghost', category: 'Special', isZ: true},
  'Psychic Terrain': {bp: 0, type: 'Grass'},
  'Pulverizing Pancake': {
    bp: 210,
    type: 'Fairy',
    makesContact: true,
  ...
  'Revelation Dance': {bp: 90, type: 'Fairy', category: 'Special', zp: 175},
  'Sappy Seed': {bp: 90, type: 'Fighting', category: 'Physical', zp: 175},
  'Savage Spin-Out': {bp: 1, type: 'Poison', category: 'Physical', isZ: true},
  ...
  'Shattered Psyche': {bp: 1, type: 'Grass', category: 'Physical', isZ: true},
  'Shore Up': {bp: 0, type: 'Bug'},
  'Sinister Arrow Raid': {bp: 180, type: 'Steel', category: 'Physical', isZ: true},
  'Sizzly Slide': {
    bp: 90,
    type: 'Ground',
    makesContact: true,
  ...
  'Sparkly Swirl': {bp: 90, type: 'Fire', category: 'Special', zp: 175},
  'Splintered Stormshards': {bp: 190, type: 'Ice', category: 'Physical', isZ: true},
  Spotlight: {bp: 0, type: 'Fairy', priority: 3},
  'Stoked Sparksurfer': {
    bp: 175,
    type: 'Dark',
    category: 'Special',
  ...
  'Subzero Slammer': {bp: 1, type: 'Electric', category: 'Physical', isZ: true},
  'Supersonic Skystrike': {bp: 1, type: 'Normal', category: 'Physical', isZ: true},
  'Tectonic Rage': {bp: 1, type: 'Bug', category: 'Physical', isZ: true},
  'Throat Chop': {
    bp: 80,
    type: 'Dragon',
    makesContact: true,
  ...
  'Toxic Thread': {bp: 0, type: 'Psychic'},
  'Twinkle Tackle': {bp: 1, type: 'Fire', category: 'Physical', isZ: true},
  'Zippy Zap': {
    bp: 50,
    type: 'Dark',
    willCrit: true,
  ...
  'Aurora Veil': {bp: 0, type: 'Electric'},
  'Brutal Swing': {
    bp: 60,
    type: 'Dragon',
    makesContact: true,
  ...
  'Burn Up': {bp: 130, type: 'Ground', category: 'Special', zp: 195},
  'Clanging Scales': {
    bp: 110,
    type: 'Flying',
    isSound: true,
  ...
  'Laser Focus': {bp: 0, type: 'Fairy'},
  Leafage: {bp: 40, type: 'Fighting', category: 'Physical', zp: 100},
  Liquidation: {
    bp: 85,
    type: 'Ghost',
    makesContact: true,
  ...
  'Moongeist Beam': {bp: 100, type: 'Steel', category: 'Special', zp: 180},
  'Photon Geyser': {
    bp: 100,
    type: 'Grass',
    category: 'Special',
  ...
  'Pika Papow': {bp: 0, type: 'Dark', category: 'Special', zp: 100},
  'Plasma Fists': {
    bp: 100,
    type: 'Dark',
    makesContact: true,
  ...
  'Prismatic Laser': {bp: 160, type: 'Grass', category: 'Special', zp: 200},
  'Psychic Fangs': {
    bp: 85,
    type: 'Grass',
    makesContact: true,
  ...
  'Strength Sap': {bp: 0, type: 'Fighting'},
  'SunSteel Strike': {
    bp: 100,
    type: 'Rock',
    makesContact: true,
...
const SS_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Clangorous Soul': {bp: 0, type: 'Flying', isSound: true},
  'Coaching': {
    bp: 0,
    type: 'Water',
    category: 'Status',
  ...
  'Court Change': {bp: 0, type: 'Fairy'},
  Decorate: {bp: 0, type: 'Fire'},
  'Dragon Darts': {
    bp: 50,
    type: 'Flying',
    multihit: 2,
  ...
  'Life Dew': {bp: 0, type: 'Ghost'},
  'Magic Powder': {bp: 0, type: 'Grass'},
  'Max Airstream': {
    bp: 10,
    type: 'Normal',
    category: 'Physical',
  ...
  'Max Guard': {bp: 0, type: 'Fairy', priority: 4, isMax: true},
  'Max Hailstorm': {
    bp: 10,
    type: 'Electric',
    category: 'Physical',
  ...
  'No Retreat': {bp: 0, type: 'Water'},
  Obstruct: {bp: 0, type: 'Dragon', priority: 4},
  Octolock: {bp: 0, type: 'Water'},
  Overdrive: {
    bp: 80,
    type: 'Dark',
    isSound: true,
  ...
  'Stuff Cheeks': {bp: 0, type: 'Fairy'},
  'Tar Shot': {bp: 0, type: 'Ice'},
  Teatime: {bp: 0, type: 'Fairy'},
  'Thunder Cage': {
    bp: 80,
    type: 'Dark',
    category: 'Special',
...
const SV_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Burning Bulwark': {bp: 0, type: 'Ground', priority: 4},
  'Ceaseless Edge': {
    bp: 65,
    type: 'Dragon',
    category: 'Physical',
