...
const RBY: {[name: string]: MoveData} = {
  ...
  Metronome: {bp: 0, type: 'Normal'},
  Mimic: {bp: 0, type: 'Normal'},
  Minimize: {bp: 0, type: 'Normal'},
  ...
  Growl: {bp: 0, type: 'Normal'},
  Leer: {bp: 0, type: 'Normal'},
  'Low Kick': {bp: 50, type: 'Fighting'},
  'Poison Gas': {bp: 0, type: 'Poison'},
  'Poison Powder': {bp: 0, type: 'Poison'},
  'Sky Attack': {bp: 140, type: 'Flying'},
  'String Shot': {bp: 0, type: 'Bug'},
  Surf: {bp: 95, type: 'Water'},
  'Tail Whip': {bp: 0, type: 'Normal'},
  Toxic: {bp: 0, type: 'Poison'},
  Flash: {bp: 0, type: 'Normal'},
  Hypnosis: {bp: 0, type: 'Psychic'},
...
const GSC_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Detect: {bp: 0, type: 'Fighting', hasPriority: true},
  Encore: {bp: 0, type: 'Normal'},
  Endure: {bp: 0, type: 'Normal', hasPriority: true},
  Flail: {bp: 0, type: 'Normal'},
  Foresight: {bp: 0, type: 'Normal'},
  'Future Sight': {bp: 80, type: '???'},
  'Heal Bell': {bp: 0, type: 'Normal'},
  'Icy Wind': {bp: 55, type: 'Ice'},
  'Lock-On': {bp: 0, type: 'Normal'},
  'Mind Reader': {bp: 0, type: 'Normal'},
  'Mirror Coat': {bp: 0, type: 'Psychic'},
  Moonlight: {bp: 0, type: 'Normal'},
  'Morning Sun': {bp: 0, type: 'Normal'},
  Nightmare: {bp: 0, type: 'Ghost'},
  Outrage: {bp: 90, type: 'Dragon'},
  'Powder Snow': {bp: 40, type: 'Ice'},
  Present: {bp: 0, type: 'Normal'},
  Protect: {bp: 0, type: 'Normal', hasPriority: true},
  'Psych Up': {bp: 0, type: 'Normal'},
  Pursuit: {bp: 40, type: 'Dark'},
  'Rain Dance': {bp: 0, type: 'Water'},
  Reversal: {bp: 0, type: 'Fighting'},
  Safeguard: {bp: 0, type: 'Normal'},
  Sandstorm: {bp: 0, type: 'Rock'},
  Sketch: {bp: 0, type: 'Normal'},
  'Sleep Talk': {bp: 0, type: 'Normal'},
  Spikes: {bp: 0, type: 'Ground'},
  Spite: {bp: 0, type: 'Ghost'},
  ...
  'Scary Face': {bp: 0, type: 'Normal'},
  Charm: {bp: 0, type: 'Normal'},
  ...
  'Perish Song': {bp: 0, type: 'Normal'},
  Snore: {bp: 40, type: 'Normal'},
  'Sweet Kiss': {bp: 0, type: 'Normal'},
...
const ADV_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Explosion: {isSpread: 'allAdjacent'},
  ...
  'Razor Wind': {isSpread: true},
  Reversal: {makesContact: true},
  'Rock Smash': {makesContact: true},
  'Self-Destruct': {isSpread: 'allAdjacent'},
  ...
  'Powder Snow': {isSpread: true},
  'Quick Attack': {makesContact: true},
  'Razor Leaf': {isSpread: true},
  'Rock Slide': {isSpread: true},
  ...
  'Follow Me': {bp: 0, type: 'Normal', hasPriority: true},
  Hail: {bp: 0, type: 'Ice'},
  ...
  'Magic Coat': {bp: 0, type: 'Psychic', hasPriority: true},
  Memento: {bp: 0, type: 'Dark'},
  'Nature Power': {bp: 80, type: 'Normal'},
  'Needle Arm': {bp: 60, type: 'Grass', makesContact: true},
  'Odor Sleuth': {bp: 0, type: 'Normal'},
  ...
  'Role Play': {bp: 0, type: 'Psychic'},
  'Sand Tomb': {bp: 15, type: 'Ground'},
  'Skill Swap': {bp: 0, type: 'Psychic'},
  'Smelling Salts': {bp: 60, type: 'Normal', makesContact: true},
  'Spit Up': {bp: 0, type: 'Normal'},
  Stockpile: {bp: 0, type: 'Normal'},
  Swallow: {bp: 0, type: 'Normal'},
  Taunt: {bp: 0, type: 'Dark'},
  'Teeter Dance': {bp: 0, type: 'Normal', isSpread: 'allAdjacent'},
  Tickle: {bp: 0, type: 'Normal'},
  ...
  Snatch: {bp: 0, type: 'Dark', hasPriority: true},
  'Tail Glow': {bp: 0, type: 'Bug'},
  Torment: {bp: 0, type: 'Dark'},
  'Water Sport': {bp: 0, type: 'Water'},
  Wish: {bp: 0, type: 'Normal'},
  'Air Cutter': {bp: 55, type: 'Flying', isSpread: true},
  Facade: {bp: 70, type: 'Normal', makesContact: true},
  'Grass Whistle': {bp: 0, type: 'Grass', isSound: true},
  'Heat Wave': {bp: 100, type: 'Fire', isSpread: true},
  'Hyper Voice': {bp: 90, type: 'Normal', isSound: true, isSpread: true},
  'Metal Sound': {bp: 0, type: 'Steel', isSound: true},
  'Meteor Mash': {bp: 100, type: 'Steel', makesContact: true},
  'Muddy Water': {bp: 95, type: 'Water', isSpread: true},
  ...
  'Cosmic Power': {bp: 0, type: 'Psychic'},
  ...
  Eruption: {bp: 150, type: 'Fire', isSpread: true},
  'Fake Tears': {bp: 0, type: 'Dark'},
  'Feather Dance': {bp: 0, type: 'Flying'},
  Flatter: {bp: 0, type: 'Dark'},
  'Frenzy Plant': {bp: 150, type: 'Grass'},
  Grudge: {bp: 0, type: 'Ghost'},
  'Helping Hand': {bp: 0, type: 'Normal', hasPriority: true},
  ...
  'Water Spout': {bp: 150, type: 'Water', isSpread: true},
...
const DPP_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Surf: {isSpread: 'allAdjacent', category: 'Special'},
  ...
  'Heal Block': {bp: 0, type: 'Psychic', isSpread: true},
  ...
  'Me First': {bp: 0, type: 'Normal', isSpread: true},
  ...
  'Dark Void': {bp: 0, type: 'Dark', isSpread: true},
  'Gastro Acid': {bp: 0, type: 'Poison'},
  Captivate: {bp: 0, type: 'Normal', isSpread: true},
  'Grass Knot': {
    bp: 0,
    type: 'Grass',
    makesContact: true,
...
const BW_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  'Air Slash': {hasSecondaryEffect: true},
  Blizzard: {hasSecondaryEffect: true},
  ...
  Covet: {bp: 60},
  'Dragon Rush': {hasSecondaryEffect: true},
  'Drain Punch': {bp: 75},
  ...
  'Giga Drain': {bp: 75},
  'Gunk Shot': {hasSecondaryEffect: true},
  'Heat Wave': {hasSecondaryEffect: true},
  'Ice Beam': {hasSecondaryEffect: true},
  ...
  'Rock Tomb': {hasSecondaryEffect: true},
  'Sand Tomb': {bp: 35},
  'Secret Power': {hasSecondaryEffect: true},
  Smog: {hasSecondaryEffect: true},
  Snore: {hasSecondaryEffect: true},
  Stomp: {hasSecondaryEffect: true},
  Thunder: {hasSecondaryEffect: true},
  Thunderbolt: {hasSecondaryEffect: true},
  Uproar: {bp: 90},
  Whirlpool: {bp: 35},
  'Petal Dance': {bp: 120},
  ...
  Constrict: {hasSecondaryEffect: true},
  'Dizzy Punch': {hasSecondaryEffect: true},
  'Hyper Fang': {hasSecondaryEffect: true},
  'Jump Kick': {bp: 100},
  'Luster Purge': {hasSecondaryEffect: true},
  'Mirror Shot': {hasSecondaryEffect: true},
  'Mist Ball': {hasSecondaryEffect: true},
  'Mud Bomb': {hasSecondaryEffect: true},
  'Needle Arm': {hasSecondaryEffect: true},
  'Ominous Wind': {hasSecondaryEffect: true},
  'Rock Climb': {hasSecondaryEffect: true},
  'Rolling Kick': {hasSecondaryEffect: true},
  'Sacred Fire': {hasSecondaryEffect: true},
  'Seed Flare': {hasSecondaryEffect: true},
  'Signal Beam': {hasSecondaryEffect: true},
  'Silver Wind': {hasSecondaryEffect: true},
  Twineedle: {hasSecondaryEffect: true},
  Acid: {hasSecondaryEffect: true},
  'Ancient Power': {hasSecondaryEffect: true},
  Astonish: {hasSecondaryEffect: true},
  'Aurora Beam': {hasSecondaryEffect: true},
  'Beat Up': {bp: 0},
  Bite: {hasSecondaryEffect: true},
  'Blaze Kick': {hasSecondaryEffect: true},
  'Bubble Beam': {hasSecondaryEffect: true},
  'Bullet Seed': {bp: 25},
  'Charge Beam': {hasSecondaryEffect: true},
  Confusion: {hasSecondaryEffect: true},
  'Cross Poison': {hasSecondaryEffect: true},
  Crunch: {hasSecondaryEffect: true},
  'Crush Claw': {hasSecondaryEffect: true},
  Curse: {type: 'Ghost'},
  ...
  Headbutt: {hasSecondaryEffect: true},
  'High Jump Kick': {bp: 130},
  'Ice Fang': {hasSecondaryEffect: true},
  'Ice Punch': {hasSecondaryEffect: true},
  'Icicle Spear': {bp: 25},
  'Icy Wind': {hasSecondaryEffect: true},
  'Iron Head': {hasSecondaryEffect: true},
  'Iron Tail': {hasSecondaryEffect: true},
  'Last Resort': {bp: 140},
  'Lava Plume': {hasSecondaryEffect: true},
  'Metal Claw': {hasSecondaryEffect: true},
  'Mud Shot': {hasSecondaryEffect: true},
  'Mud-Slap': {hasSecondaryEffect: true},
  Octazooka: {hasSecondaryEffect: true},
  'Paleo Wave': {hasSecondaryEffect: true},
  'Poison Jab': {hasSecondaryEffect: true},
  'Poison Sting': {hasSecondaryEffect: true},
  'Poison Tail': {hasSecondaryEffect: true},
  'Powder Snow': {hasSecondaryEffect: true},
  Psybeam: {hasSecondaryEffect: true},
  Psychic: {hasSecondaryEffect: true},
  'Rock Slide': {hasSecondaryEffect: true},
  'Rock Smash': {hasSecondaryEffect: true},
  'Shadow Ball': {hasSecondaryEffect: true},
  'Shadow Strike': {hasSecondaryEffect: true},
  'Sky Attack': {hasSecondaryEffect: true},
  Sludge: {hasSecondaryEffect: true},
  'Sludge Bomb': {hasSecondaryEffect: true},
  Spark: {hasSecondaryEffect: true},
  'Steel Wing': {hasSecondaryEffect: true},
  'Thunder Fang': {hasSecondaryEffect: true},
  'Thunder Punch': {hasSecondaryEffect: true},
  ...
  'Zen Headbutt': {hasSecondaryEffect: true},
  ...
  Incinerate: {bp: 30, type: 'Fire', isSpread: true, category: 'Special'},
  'Low Sweep': {
    bp: 60,
    type: 'Fighting',
    makesContact: true,
...
const XY_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Thousand Arrows': {bp: 90, type: 'Ground', isSpread: true, category: 'Physical'},
  'Thousand Waves': {bp: 90, type: 'Ground', isSpread: true, category: 'Physical'},
  'Water Shuriken': {
    bp: 15,
    type: 'Water',
    isMultiHit: true,
  ...
  "Land's Wrath": {bp: 90, type: 'Ground', isSpread: true, category: 'Physical'},
  ...
  'Dazzling Gleam': {bp: 80, type: 'Fairy', isSpread: true, category: 'Special'},
  'Disarming Voice': {
    bp: 40,
    type: 'Fairy',
    isSound: true,
  ...
  'Venom Drench': {bp: 0, type: 'Poison', isSpread: true},
};
...
const SS_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Rage: {maxPower: 90},
  'Rapid Spin': {bp: 50, hasSecondaryEffect: true, maxPower: 100},
