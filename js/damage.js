...
function getDamageResult(attacker, defender, move, field) {
	...
	if ((defAbility === "Multiscale" || defAbility === "Shadow Shield") && defender.curHP === defender.maxHP && !field.isSR && (!field.spikes || (defAbility === "Multiscale" && field.spikes && [defender.type1, defender.type2].indexOf("Flying") != -1))) {
